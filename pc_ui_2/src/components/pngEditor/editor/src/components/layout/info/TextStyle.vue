<template>
  <div>
    <el-row v-for="(block, index) in fontStyleListFormat" :key="index">
      <el-button-group style="display: inline-flex;">
        <el-tooltip v-for="(item,ind) in block" :key="ind" placement="top" :show-after="300" :content="item.label">
          <el-button
    ...
    <el-row :gutter="10">
      ...
      <el-col :span="14">
        <el-input v-model="store.current.text" type="textarea" />
      </el-col>
    </el-row>
  </div>
</template>
