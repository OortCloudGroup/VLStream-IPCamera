<template>
  ...
  >
    <el-row :gutter="10">
      <el-col :span="12">
        <InputNumber v-model="store.current.left" prefix="X" />
      </el-col>
      <el-col :span="12">
        <InputNumber v-model="store.current.top" prefix="Y" />
      </el-col>
    </el-row>

    <el-row :gutter="10">
      <el-col :span="12">
        <InputNumber v-model="store.current.width" prefix="W" />
      </el-col>
      <el-col :span="12">
        <InputNumber v-model="store.current.height" prefix="H" />
      </el-col>
    </el-row>

    <el-row :gutter="10">
      <el-col :span="12">
        <InputNumber v-model="store.current.angle" prefix="旋转" />
      </el-col>
      <el-col :span="12" class="es-col">
        <div class="text-btn" @click="handleUpdateAngle(-45)">
    ...
    <el-row>
      <el-button-group style="display: inline-flex;">
        <el-tooltip v-for="item in alignX" placement="top" :show-after="300" :content="item.label">
          <el-button style="flex: 1;" @click="handleAlign(item.value)">
