<template>
  <div class="appN_Page">
    <el-form ref="smnForm" class="deptNForm" label-position="top" :model="form" :rules="rules">
      ...
      <el-form-item label="安全问题1" prop="name">
        <el-input v-model="form.name" placeholder="请输入" />
      </el-form-item>
      <el-form-item label="答案" prop="name">
        <el-input v-model="form.name" placeholder="请输入" />
      </el-form-item>
      <el-form-item label="安全问题2" prop="name">
        <el-input v-model="form.name" placeholder="请输入" />
      </el-form-item>
      <el-form-item label="答案">
        <el-input v-model="form.name" placeholder="请输入" />
      </el-form-item>
      <el-form-item label="安全问题3" prop="name">
        <el-input v-model="form.name" placeholder="请输入" />
      </el-form-item>
      <el-form-item label="答案">
        <el-input v-model="form.name" placeholder="请输入" />
      </el-form-item>
      <div class="set_secu flexRowAC">
        安全问题配置<img class="BtnImg" src="@/assets/img/camera/btn/tip.png" alt="" />
      </div>
