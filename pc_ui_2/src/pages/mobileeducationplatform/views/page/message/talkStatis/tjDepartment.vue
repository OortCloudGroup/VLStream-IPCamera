...
import { deptList, getDepartmentStatistics } from '@/api/mobileeducationplatform/case'
...
const handleExport = async() => {
  ...
  const downloadUrl = Config.URL + Config.gateWay + 'oortcloud-educationtalk' + '/report/exportDepartmentStatistics'
  let res = await request({ url: downloadUrl, method: 'post', data: params, responseType: 'blob' }, true)
  ElMessage.success('正在导出中...')
  downloadBlob(res, '组织结构谈话统计.xlsx')
}
