    ...
    <div class="main-content">
      ...
      <div class="content-area">
        <div class="filter-bar">
          ...
          <!-- <div class="filter-item">
            <span class="filter-label">民警编码：</span>
        ...
        <el-table :data="tableData" style="width: 100%">
          ...
          <!-- 月份 -->
          <el-table-column prop="talkMonth" label="月份" align="center" />
          <el-table-column prop="conversationCoverage" label="完成率" align="center">
            <template #default="{ row }">
              <span>{{ (row.conversationCoverage).toFixed(2) }}%</span>
            </template>
          </el-table-column>
        </el-table>
...
import { deptList, getPoliceCompletionRateStatistics } from '@/api/mobileeducationplatform/case'
...
const getList = async() => {
  ...
  const res = await getPoliceCompletionRateStatistics(params)
...
const handleExport = async() => {
  ...
  const downloadUrl = Config.URL + Config.gateWay + 'oortcloud-educationtalk' + '/report/exportPoliceCompletionRateStatistics'
  let res = await request({ url: downloadUrl, method: 'post', data: params, responseType: 'blob' }, true)
  ElMessage.success('正在导出中...')
  downloadBlob(res, '谈话完成率统计.xlsx')
}
