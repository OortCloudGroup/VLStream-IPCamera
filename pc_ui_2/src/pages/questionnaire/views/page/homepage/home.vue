<template>
  <div class="homePage">
    ...
    <el-tabs v-model="activeName" class="tenanat-tabs">
      <el-tab-pane label="发布中" name="h1" />
      <el-tab-pane label="暂停发布" name="h2" />
    </el-tabs>
    <div v-if="activeName==='h1'" class="flexRowAC quesCon">
      ...
      <div v-for="(item,i) in satiQuesL" :key="i" class="satiQues">
        ...
        <div class="saOpeBoxOut flexRowAC">
          <div class="flexRowAC saOpeBox">
            <el-dropdown>
              <div class="saOpeT flexRowAC">
                <img class="saOpeImg" :src="assess" alt="" />
                设计
                <el-icon>
                  <CaretBottom />
                </el-icon>
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  <el-dropdown-item @click="statiResultFn('/question')">
                    编辑问卷
                  </el-dropdown-item>
                  <el-dropdown-item @click="quesSet">
                    问卷设置
                  </el-dropdown-item>
                  <el-dropdown-item>保存为模板</el-dropdown-item>
                </el-dropdown-menu>
              </template>
            </el-dropdown>
            <el-dropdown>
              <div class="saOpeT flexRowAC">
                <img class="saOpeImg" :src="vote" alt="" />
                分享
                <el-icon>
                  <CaretBottom />
                </el-icon>
            ...
            <el-dropdown>
              <div class="saOpeT flexRowAC">
                <img class="saOpeImg" :src="sign" alt="" />
                分析&下载
                <el-icon>
                  <CaretBottom />
                </el-icon>
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  <el-dropdown-menu>
                    ...
                    <el-dropdown-item @click="statiResultFn('/statiResult')">
                      统计结果
                    </el-dropdown-item>
                  </el-dropdown-menu>
                </el-dropdown-menu>
          ...
          <div class="flexRowAC saOpeBox">
            ...
            <div class="saOpeT flexRowAC">
              <img class="saOpeImg" :src="del" alt="" />
              删除
            </div>
            <div class="saOpeT flexRowAC">
              <img class="saOpeImg" :src="copy" alt="" />
    ...
    >
      <ques-set-index :item="dObj" @close="dVisi=false" @handle="getlistFn" />
    </el-drawer>
  </div>
</template>
...
import del from '@/assets/img/questionnaire/delete.png'
import QuesSetIndex from '@/pages/questionnaire/views/page/homepage/quesSet.vue'
...
const dVisi = ref<boolean>(false)// 问卷设置
const direction = ref<any>('rtl') // 详情左
const dObj = ref<any>('')// 问卷设置
const activeName = ref('h1')
