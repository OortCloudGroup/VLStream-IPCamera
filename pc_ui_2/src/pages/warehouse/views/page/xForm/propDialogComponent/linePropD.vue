    ...
    <div v-if="activeTab === 1" class="prop_group">
      ...
      <div class="prop_group_item">
        <div class="prop_group_item1">
          ...
          <div class="prop_group_item_content">
            <el-input-number v-model="style.strokeWidth" controls-position="right" />
          </div>
        </div>
        <div class="prop_group_item1">
      ...
      <div class="prop_group_item">
        <div class="prop_group_item1">
          ...
          <div class="prop_group_item_content">
            <el-select v-model="style.strokeDasharray" :popper-append-to-body="false" placeholder="请选择">
              <el-option label="实线" value="" />
              <el-option label="虚线" value="5,5" />
              <el-option label="虚线样式一" value="10,10" />
              <el-option label="虚线样式二" value="20,10,5,5,5,10" />
            </el-select>
          </div>
        </div>
      </div>
      ...
      <div class="prop_group_item">
        <div class="prop_group_item1 content_deg">
