...
<template>
  <div class="prop">
      ...
      <div class="prop_group_item">
        <div class="prop_group_item1">
          ...
          <div class="prop_group_item_content">
            <el-select v-model="style.flexDirection" :popper-append-to-body="false" placeholder="请选择">
    ...
    <div v-if="activeTab === 2" class="prop_group">
      ...
      <el-radio-group v-model="other.fieldValue">
        <div v-for="(item,index) in other.options" :key="index" class="prop_group_item">
          ...
          <div class="prop_group_item1">
            <el-radio style="margin: 0 12px" :label="item.value">
              默认选择
            </el-radio>
          </div>
