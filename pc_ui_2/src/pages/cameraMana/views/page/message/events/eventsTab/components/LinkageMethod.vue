<template>
  <div class="linkageMethod">
    <div class="linkage-container">
      ...
      <div class="linkage-column">
        <div class="column-header">
          <el-checkbox v-model="form.linkage_video" @change="handleVideoLinkageChange" />
          录像联动
        </div>
        <div class="column-content">
          <div class="checkbox-item">
            <el-checkbox v-model="form.A1" @change="handleVideoLinkageItemChange">
              A1
            </el-checkbox>
          </div>
        </div>
